...
var ButtonGroup = ({ children, className, outline, pill, theme: customTheme = {}, ...props }) => {
  const items = (0, import_react8.useMemo)(() => import_react8.Children.map(children, (child, index2) => (0, import_react8.cloneElement)(child, {
    outline,
    pill,
...
var DropdownComponent = ({ children, className, dismissOnClick = true, theme: customTheme = {}, renderTrigger, ...props }) => {
  ...
  const handleSelect = (0, import_react25.useCallback)((index2) => {
    setSelectedIndex(index2);
    setOpen(false);
  }, []);
  const handleTypeaheadMatch = (0, import_react25.useCallback)((index2) => {
    if (open) {
